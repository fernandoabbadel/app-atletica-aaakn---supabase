...
export const APP_PAGES = [
    ...
    { path: '/master/lancamento', label: 'Lancamento Master' },
    { path: '/master/lancamento/ativacoes', label: 'Lancamento Master - Ativacoes' },
    { path: '/master/lancamento/convites', label: 'Lancamento Master - Convites' },
    { path: '/master/lancamento/pendentes', label: 'Lancamento Master - Pendentes' },
