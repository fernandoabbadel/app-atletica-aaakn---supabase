...
export const APP_PAGES = [
    ...
    { path: '/admin/cadastro', label: 'Admin Cadastro' },
    ...
    { path: '/admin/master/lancamento', label: 'Lancamento Master' },
    { path: '/admin/master/lancamento/ativacoes', label: 'Lancamento Master - Ativacoes' },
    { path: '/admin/master/lancamento/convites', label: 'Lancamento Master - Convites' },
    { path: '/admin/master/lancamento/pendentes', label: 'Lancamento Master - Pendentes' },
