...
export default function ConfigPedidosPlanosPage() {
  return (
    <div className="min-h-screen bg-[#050505] text-white pb-24 font-sans">
      <header className="p-4 sticky top-0 z-30 flex items-center gap-4 border-b border-white/5 bg-[#050505]/90 backdrop-blur-md">
        ...
        <h1 className="font-black text-xl italic uppercase tracking-tighter text-white">Pedidos Planos</h1>
      </header>
      <PedidosByTypePage tab="planos" />
    </div>
  );
}
