...
import { fetchBannedAppeals, type AdminReportRecord } from "../../../../lib/reportsService";
    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans pb-20">
      <header className="sticky top-0 z-20 bg-[#050505]/90 backdrop-blur-md border-b border-zinc-800 px-6 py-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-500 font-bold">Recursos e apelacoes</p>
          </div>
        </div>
      </header>
      ...
      <main className="px-6 py-6 max-w-5xl mx-auto space-y-3">
        {loading ? (
          ...
          <div className="text-sm text-zinc-500 border border-zinc-800 rounded-xl p-5">Sem recursos pendentes.</div>
        ) : (
          paged.map((row) => (
