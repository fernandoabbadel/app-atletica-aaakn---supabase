...
export default function MasterContatoPage() {
          ...
          paged.map((row) => {
            ...
            return (
              ...
              >
                ...
                <p className="rounded-xl border border-zinc-800 bg-black/30 p-3 text-xs whitespace-pre-wrap text-zinc-300">
                  {row.descricao}
                </p>
